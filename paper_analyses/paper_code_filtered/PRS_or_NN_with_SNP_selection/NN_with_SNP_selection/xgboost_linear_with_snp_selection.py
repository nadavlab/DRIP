...
def XGBRegressor_incremental(x_train_chunks_file, y_train_chunks_file, X_val, y_val, output_path,pheno_name, pretrain=False, model=None):
    ...
    for epoch in range(1,41):
        ...
        if epoch%10 == 0:
            ...
            #save_to = "/home/hochyard/my_model/autoencoder/autoencoder_models_5_layers_prelu_act_no_cov_adam0.00001_batch_size250/"+pheno_name+"_pheno/XGB/incremental_xgboost_regressor_MinMax_scaled_cov_MinMax_scaled_max_depth5_learning_rate0.001_subsample1.0_olsample_bytree0.2_gamma0.01_40_epochs/"+str(epoch) #for Autoencoder
...
def plot_loss(loss, val_loss, pheno_name,output_path):
    ...
    #name = "/home/hochyard/my_model/autoencoder/autoencoder_models_5_layers_prelu_act_no_cov_adam0.00001_batch_size250/"+pheno_name+"_pheno/XGB/incremental_xgboost_regressor_MinMax_scaled_cov_MinMax_scaled_max_depth5_learning_rate0.001_subsample1.0_olsample_bytree0.2_gamma0.01_40_epochs/logloss.png"
    fig.savefig(name)
...
output_path = "/path/to/your/project/XGB_with_SNP_selection/"+pheno_name+"/rep"+rep+"/incremental_xgboost_regressor_MinMax_scaled_cov_MinMax_scaled_max_depth5_learning_rate0.001_subsample1.0_olsample_bytree0.2_gamma0.01_40_epochs/"
...
#XGB.load_model("/path/to/your/project/XGB_with_SNP_selection/"+pheno_name+"/rep"+rep+"/incremental_xgboost_regressor_MinMax_scaled_cov_MinMax_scaled_max_depth5_learning_rate0.001_subsample1.0_olsample_bytree0.2_gamma0.01_40_epochs/XGBRegressor_model")
###############################################prediction only#############################################
