...
def build_model(number_features, learning_rate=1e-7, dropout=0.1):
    """
...
def fit_nn(
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # Save the best validation-loss checkpoint, but always complete all epochs.
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=80,
        help="Number of training epochs. Default: 80, matching the real-phenotype PCA/autoencoder DNN.",
    )
