...
if DRM == "PCA":
    ...
    output_path = "/path/to/your/project/our_model/PCA/logistic_regression/"+pheno_name+"/rep"+rep+"/eta0_0.01_l2_lr_optimal_1500"
    #output_path = "/path/to/your/project/our_model/PCA/logistic_regression/"+pheno_name+"/rep"+rep+"/genetic_only"
...
#metrics_file = os.path.join("/path/to/your/project/our_model/PCA/logistic_regression/metrics_log_genetic_only.csv")
metrics_file = os.path.join("/path/to/your/project/our_model/PCA/logistic_regression/eta0_0.01_l2_lr_optimal_1500_metrics_log.csv")
